      ...
      body: Padding(
        ...
        child: Form(
          ...
          child: SingleChildScrollView(
            //Here Listener to make Navigate as emit state
            child: BlocListener<AuthCubit, AuthState>(
              listener: (context, state) {
                if (state.authStates == AuthStates.fail) {
                  ...
                  // Temporary snackBar until complete home page;
                  ScaffoldMessenger.of(
                    context,
                  ).showSnackBar(SnackBar(content: Text("Login Success")));
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>ReviewingResultScreen()));
                } else {
                  //loading state
                }
              },
