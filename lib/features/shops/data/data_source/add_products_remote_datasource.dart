...
class AddProductsRemoteDatasourceImpl implements AddProductsRemoteDatasource {
  final FirebaseFirestore firestore;
  final FirebaseStorage storage;
  AddProductsRemoteDatasourceImpl({required this.firestore, required this.storage});
  @override
  Future<void> addProduct({
    required String name,
    required String description,
